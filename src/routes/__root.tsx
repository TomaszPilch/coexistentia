  ...
  head: () => ({
    meta: [
      ...
      { title: "Coex Hrádek — Wspólnie dla naszej wioski" },
      {
        name: "description",
        content:
          "Strona komitetu wyborczego Coex Hrádek. Polska grupa w Czechach — wspólnie dla naszej wioski. Společně pro naši vesnici.",
      },
      { name: "author", content: "Coex Hrádek" },
      { name: "theme-color", content: "#142c52" },
      { property: "og:title", content: "Coex Hrádek — Wspólnie dla naszej wioski" },
      {
        property: "og:description",
        content: "Polska grupa w Czechach. Wspólnie dla naszej wioski / Společně pro naši vesnici.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@coexhradek" },
    ],
    links: [
